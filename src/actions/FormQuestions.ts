...
const addEligibilityQuestionUrl = urls.baseUrl + urls.api.formQuestions.addEligibilityQuestion;
const addDocumentQuestionUrl = urls.baseUrl + urls.api.formQuestions.addDocumentQuestion;
const addOtherQuestionUrl = urls.baseUrl + urls.api.formQuestions.addOtherQuestion;
const editEligibilityQuestionUrl = urls.baseUrl + urls.api.formQuestions.editEligibilityQuestion;
const editDocumentQuestionUrl = urls.baseUrl + urls.api.formQuestions.editDocumentQuestion;
const editOtherQuestionUrl = urls.baseUrl + urls.api.formQuestions.editOtherQuestion;
const removeEligibilityQuestionUrl = urls.baseUrl + urls.api.formQuestions.removeEligibilityQuestion;
const removeDocumentQuestionUrl = urls.baseUrl + urls.api.formQuestions.removeDocumentQuestion;
const removeOtherQuestionUrl = urls.baseUrl + urls.api.formQuestions.removeOtherQuestion;
...
export const editEligibilityQuestion = async (question: EligibilityQuestion) => {
    return internalRequest<EligibilityQuestion>({
